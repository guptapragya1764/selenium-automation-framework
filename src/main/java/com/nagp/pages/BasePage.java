...
public class BasePage {
    ...
    public void moveTElementByJS(By by, WaitStrategy waitStrategy, String elementName) {
        explicitWaitElement(by, waitStrategy);
        ...
        js.executeScript(script, getDriver().findElement(by));
    ...
    public void moveTElement(By by, WaitStrategy waitStrategy, String elementName) {
        new Actions(getDriver()).moveToElement(explicitWaitElement(by, waitStrategy)).build().perform();
        String message = format(HOVERED_MESSAGE, elementName);
        pass(message);
        info(message);
    }
    ...
    protected void clear(By by, WaitStrategy waitStrategy) {
        scrollIntoElement(by, waitStrategy).clear();
    }
    ...
    protected void sendKeysForPassword(By by, String value, WaitStrategy waitStrategy, String elementName) {
        scrollIntoElement(by, waitStrategy).sendKeys(value);
        String message = format(PASSWORD_ENTERED_MESSAGE, elementName);
        pass(message);
        info(message);
    }
    ...
    protected void switchToIframe(String idOrName) {
        waitForFrame(idOrName);
        String message = format(SWITCHED_TO_FRAME_MESSAGE, idOrName);
        pass(message);
        info(message);
    }
